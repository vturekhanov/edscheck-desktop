...
Проверить можно самим EDScheck: перетащите в окно `.cms`, приложение распознает отдельную подпись и попросит указать подписанный файл — выберите скачанный `.dmg` или `.deb`.
