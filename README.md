...
> [!WARNING]
> **ВНИМАНИЕ!** Приложение предназначено для проверки подлинности ЭЦП. При возникновении сомнений обратитесь за консультацией к [специалисту](https://sigex.kz/blog/2021-01-25-digital-signatures-in-courts/#where-to-find-experts).
...
Проверить можно самим EDScheck: перетащите в окно `.cms`, приложение распознает отсоединённую подпись и попросит указать подписанный файл — выберите скачанный `.dmg` или `.deb`.
