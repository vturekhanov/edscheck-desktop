...
Десктопное приложение для проверки электронной цифровой подписи (ЭЦП) в CMS-контейнерах и Карточках электронного документа PDF (`ddcard`) по законодательству Республики Казахстан. Начиная с версии 1.2.0 в экспериментальном режиме поддерживается проверка ЭЦП форматов XAdES, XMLDSig, ЭСФ в файлах XML.
...
- Attached CMS, [Карточки электронного документа](https://github.com/kaarkz/ddcard) и XML (XAdES/XMLDSig/ЭСФ) проверяются сразу
