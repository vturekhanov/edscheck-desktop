...
RUNTIME_LIB_JARS="flatlaf-3.7.2-no-natives.jar pdfbox-3.0.7.jar pdfbox-io-3.0.7.jar commons-logging-1.4.0.jar xmlsec-3.0.3.jar slf4j-api-2.0.9.jar slf4j-nop-2.0.9.jar bcprov-jdk18on-1.85.2.jar bcutil-jdk18on-1.85.jar bcpkix-jdk18on-1.85.jar"
...
MODULES="java.base,java.desktop,java.instrument,java.logging,java.net.http,jdk.crypto.ec,java.xml.crypto,java.naming,java.sql"
